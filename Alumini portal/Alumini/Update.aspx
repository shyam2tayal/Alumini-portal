<%@ Page Language="C#" MasterPageFile="~/Student/index.master" AutoEventWireup="true"
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <table style="width: 100%;">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtenroll" runat="server" ReadOnly="true"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="ddlyear" runat="server" Width="28%">
                </asp:TextBox>
            </td>
        </tr>
        <tr>
