<%@ Page Language="C#" MasterPageFile="~/Teacher/index.master" AutoEventWireup="true"
    CodeFile="Update.aspx.cs" Inherits="Teacher_Update" Title="Untitled Page" %>
    ...
    <table align="center">
        <tr>
            <td>
                ...
                <asp:Label ID="Labe120" runat="server" CssClass="label" Text=""></asp:Label>
            </td>
        </tr>
    </table>
    <table align="center">
        ...
        <tr>
            ...
            <td class="style1">
                ...
                <asp:CalendarExtender runat="server" ID="cc" TargetControlID="DoB">
        ...
        <tr>
            ...
            <td class="style1">
                <asp:TextBox ID="Subject" runat="server" Width="219px" ReadOnly="false"></asp:TextBox>
